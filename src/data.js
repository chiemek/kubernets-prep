...
export const quizData5 = [
        ...
        },
        {
          ...
          correctAnswer:
            "B. Managing the underlying compute instances, OS patching, and runtime updates",
          explanation:
            "With FaaS, the provider manages the entire underlying infrastructure stack—physical servers, VMs, operating systems, patching, container runtimes (if used underneath), and language runtimes. The user focuses only on the function code.",
          competency: "Serverless",
        },
        {
          question:
